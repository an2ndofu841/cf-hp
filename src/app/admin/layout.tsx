...
export default async function AdminLayout({
  ...
  return (
    <div className={`${geistSans.variable} ${geistMono.variable} antialiased admin-body flex min-h-screen bg-zinc-50 dark:bg-zinc-950 font-sans text-zinc-900 dark:text-zinc-100 selection:bg-zinc-900 selection:text-white dark:selection:bg-white dark:selection:text-black`}>
      <AdminSidebar />
