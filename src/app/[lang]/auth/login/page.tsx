        ...
        <div className="flex-1 flex flex-col justify-center">
          <PixelCard className="flex flex-col gap-6 border-4 border-foreground shadow-xl">
            <div className="text-center border-b-4 border-dashed border-gray-300 pb-4">
               <h2 className="text-2xl font-bold uppercase">ADVENTURE LOG</h2>
               <p className="text-xs text-gray-500">RESUME GAME</p>
            </div>
            ...
            <div className="text-center text-sm mt-4">
                <p className="mb-2 text-gray-500">First time here?</p>
                <PixelButton href={`/${lang}/auth/signup`} variant="outline" size="sm">
                    NEW GAME (SIGN UP)
                </PixelButton>
            </div>
          </PixelCard>
